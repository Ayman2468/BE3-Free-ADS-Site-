                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="remember" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                {{__("msg.Don't have an account?")}}<a class="btn btn-link" href="{{ route('register') }}">{{ __('msg.Register') }}</a>
                                @endif
                                </li>
                            </div>
                        </div>
